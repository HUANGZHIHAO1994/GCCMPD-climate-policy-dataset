...
e = open("/home/zhhuang/climate_policy_paper/code/files/CDR_NETS.csv", 'a+', encoding='utf-8-sig', newline='')
...
res_1 = str(get_page(
    'https://cdrlaw.org/technical-pathway/negative-emission-technologies/?_cdr_res_type=pleg%2Cdec%2Cpop%2Cpol%2Celeg%2Cnew%2Chear')).replace(
    '\\', '')
# print(res_1)
max_page = int(
...
for i in range(1, max_page + 1):
    if i == 1:
        ...
        url_2 = 'https://cdrlaw.org/technical-pathway/negative-emission-technologies/?_cdr_res_type=pleg%2Cdec%2Cpop%2Cpol%2Celeg%2Cnew%2Chear&_paged={}'.format(
            i)
    for r_t in range(3):
        try:
    ...
    for url_3 in url_list:
        try:
            ...
            try:
                ...
                Policy_Content_txt = ''
            try:
                Type = data_3.xpath('//div[@class="resource-type"]/text()')[0]
            except:
                Type = ''
            Source = 'CDR_NETS'
            e = open("/home/zhhuang/climate_policy_paper/code/files/CDR_NETS.csv", 'a+', encoding='utf-8-sig', newline='')
