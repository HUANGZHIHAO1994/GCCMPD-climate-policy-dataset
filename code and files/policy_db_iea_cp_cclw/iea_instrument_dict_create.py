...
if __name__ == '__main__':
    ...
    iea_instrument['Environmental Impact Assessment'] = ['No', 'Regulatory Approaches;Information Programmes', '']
    ...
    iea_instrument['Knowledge networks'] \
        = ['Sector', 'Government Provision of Public Goods or Services;Information Programmes',
           {"Multi-sector": "",
    ...
    iea_instrument['Knowledge sharing requirements'] \
        = ['Sector', 'Government Provision of Public Goods or Services;Information Programmes;Regulatory Approaches',
           {"Multi-sector": "",
            "Energy systems": "Government Provision of Public Goods or Services:Research and development",
            "Transport": "",
            "Buildings": "",
    ...
    iea_instrument['Performance-based policies'] = ['No', 'Information Programmes', '']
    # like: NOM-022-ENER/SCFI-2000: Energy efficiency, user safety requirements and elimination of chlorofluorocarbons (CFC s) for self-contained commercial refrigerators. Limits, testing and labeling methods
    ...
    iea_instrument['Rights, permits and licenses'] = ['No', 'Regulatory Approaches;Information Programmes', '']
    ...
    iea_instrument['permits and licenses'] = ['No', 'Regulatory Approaches;Information Programmes', '']
