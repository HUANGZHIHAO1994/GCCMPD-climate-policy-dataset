...
def process():
    ...
    df = pd.read_excel('/home/zhhuang/climate_policy_paper/code/data/all_policies_mitigation_result_for_topic.xlsx')
    try:
    ...
    # df = df[['Policy', 'Policy_Content', 'Year', 'ISO_code', 'IPCC_Region', 'Annex']]
    df = df[["Index", 'Policy', 'Policy_Content', 'Year', 'Country']]
    ...
    with pd.ExcelWriter("Topic_docs_time.xlsx", engine='xlsxwriter',
