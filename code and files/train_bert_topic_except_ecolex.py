...
def analyze(args):
    ...
    topic_model.save(os.path.join(args.save_dir, f'bert_topic_except_ecolex_model'))
    ...
    with pd.ExcelWriter("Topic_except_ecolex.xlsx", engine='xlsxwriter',
...
def parser():
    ...
    parser.add_argument('--nr_topics', default=40, type=int)
