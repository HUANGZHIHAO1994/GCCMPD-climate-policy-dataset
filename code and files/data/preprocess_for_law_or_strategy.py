...
def load_excel():
    ...
    df = df[['Policy', 'Policy_Content', 'law or strategy']]
    df = df.drop(df[(df['law or strategy'] == "Constitution") | (df['law or strategy'] == "International Law")].index)
...
def get_label(samples):
    ...
    with open('labels2ids_law_or_strategy.json', 'w', encoding='utf8') as file:
...
if __name__ == '__main__':
    ...
    save_jsonl('train_law_or_strategy.jsonl', train)
    save_jsonl('test_law_or_strategy.jsonl', test)
