...
def process():
    ...
    df = pd.read_excel('/home/zhhuang/climate_policy_paper/code/data/policy_db_complete.xlsx',
    ...
    with pd.ExcelWriter("Topic_docs_time_iea_cp_cclw.xlsx", engine='xlsxwriter',
