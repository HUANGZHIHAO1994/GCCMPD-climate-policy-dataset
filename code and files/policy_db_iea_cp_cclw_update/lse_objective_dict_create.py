...
if __name__ == '__main__':
    ...
    lse_objective['electromobility'] = ['Social', 'Social:Energy/mobility access']
    ...
    lse_objective['Carbon accounting'] = ['', '']
    lse_objective['reinsurance'] = ['', '']
    lse_objective['heat'] = ['', '']
    lse_objective['TCFD'] = ['', '']
    lse_objective['ccs'] = ['', '']
    lse_objective['national security'] = ['', '']
    ...
    lse_objective['GHG'] = ['', '']
    lse_objective['Sd Gs'] = ['', '']
    lse_objective['Energy transition'] = ['', '']
    lse_objective['Ozone'] = ['', '']
    lse_objective['Natural Resources'] = ['', '']
    lse_objective['Tax incentives'] = ['', '']
    lse_objective['Livestock'] = ['', '']
    lse_objective['Ozone'] = ['', '']
    lse_objective['Healthy Environment'] = ['Environmental', '']
    lse_objective['Cc Gap'] = ['', '']
    lse_objective['LULUCF'] = ['', '']
    ...
    lse_objective['Climate risk'] = ['', '']
    lse_objective['adaptation planning'] = ['', '']
    lse_objective['motor vehicles'] = ['', '']
    lse_objective['autos'] = ['', '']
    lse_objective['insurance'] = ['', '']
    lse_objective['environmental impact assessment'] = ['Environmental', '']
    lse_objective['BRT'] = ['', '']
    lse_objective['banking'] = ['', '']
    lse_objective['afforestation'] = ['', '']
    lse_objective['Green bonds'] = ['', '']
    lse_objective['tax'] = ['', '']
    lse_objective['Slc Ps'] = ['', '']
    lse_objective['afforestation'] = ['', '']
    lse_objective['carbon budget'] = ['', '']
    lse_objective['Equity'] = ['', '']
    lse_objective['fossil fuels subsidies'] = ['', '']
    lse_objective['Climate Emergency'] = ['', '']
    lse_objective['taxonomy'] = ['', '']
    lse_objective['climate security'] = ['', '']
    lse_objective['road'] = ['', '']
    lse_objective['afforestation'] = ['', '']
    ...
    lse_objective['road'] = ['', '']
    lse_objective['K Ets'] = ['', '']
    lse_objective['cities'] = ['', '']
    lse_objective['ghg emissions'] = ['', '']
    lse_objective['Investment'] = ['', '']
    lse_objective['reporting'] = ['', '']
    lse_objective['Climate Change Act'] = ['', '']
    lse_objective['social justice'] = ['', '']
    lse_objective['E Buses'] = ['', '']
    lse_objective['Physical activity'] = ['', '']
    lse_objective['Green bonds'] = ['', '']
    lse_objective['banking'] = ['', '']
    lse_objective['fossil fuels subsidies'] = ['', '']
    lse_objective['Wetlands'] = ['', '']
    lse_objective['Climate Justice'] = ['', '']
    lse_objective['cities'] = ['', '']
    lse_objective['international climate commitments'] = ['', '']
    lse_objective['Culture'] = ['', '']
    lse_objective['Land Use'] = ['', '']
    ...
    lse_objective['mining'] = ['', '']
    lse_objective['digital transition'] = ['', '']
    lse_objective['benchmark'] = ['', '']
    lse_objective['airport'] = ['', '']
    lse_objective['Active Travel'] = ['', '']
    lse_objective['train'] = ['', '']
    lse_objective['trading scheme'] = ['', '']
    lse_objective['Amazon forest'] = ['Environmental', '']
    lse_objective['Fossil Fuels Curbing Measures'] = ['', '']
    lse_objective['Environmental permit'] = ['Environmental', '']
    lse_objective['future generations'] = ['', '']
    lse_objective['maritime planning'] = ['', '']
    lse_objective['investment'] = ['', '']
    lse_objective['clothing'] = ['', '']
    lse_objective['travel'] = ['', '']
    lse_objective['Covid-19'] = ['', '']
    lse_objective['UNFCCC'] = ['', '']
    lse_objective['Carbon Credits'] = ['', '']
    lse_objective['ambition'] = ['', '']
    lse_objective['Oil And Gas'] = ['', '']
    lse_objective['Multi Modal Transport'] = ['', '']
    lse_objective['National Energy and Climate Plans'] = ['', '']
    lse_objective['maritime planning'] = ['', '']
    lse_objective['skills'] = ['', '']
    lse_objective['Cattle'] = ['', '']
    lse_objective['Electromobility'] = ['Social', 'Social:Energy/mobility access']
    lse_objective['multi-modal transport'] = ['', '']
